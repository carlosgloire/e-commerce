...
<div class='max-w-lg mx-auto py-4 pl-24 pr-24  mt-[3%] text-lg rounded-lg  shadow-sm bg-gray-100'>
  ...
  <form action="" method='post' class='mb-2' enctype="multipart/form-data">
    <div class='grid'>
        ...
        <input class="rounded mb-2 w-full border-[1px] border-gray-400  px-3" type="text" name='username' value='<?php echo $name; ?>'>
    </div>
    <div class='grid'>
        <label for="mail">Mail</label>
        <input class="rounded mb-2 w-full border-[1px] border-gray-400 px-3" type="mail" name='mail' value='<?php echo $mail; ?>'>
    </div>
    <div>
        <label for="numero">Numéro de Télephone</label>
        <input class="rounded mb-2 w-full border-[1px] border-gray-400  px-3" type="phone" name="phone" value="<?php echo $phone?>">
    </div>
    <div>
        <label for="photo">Photo de profil</label>
        <input class="rounded mb-2 w-full border-[1px] border-gray-400  px-3" name="uploadfile" type="file" enctype="multipart/form-data">
    </div>
    <div class='grid mb-2'> 
        <label for="password" >Mot de passe</label>
        <input class="rounded  w-full border-[1px] border-gray-400  px-3" type="password" name='password'>
    </div>
    <div class='grid mb-4'> 
        <label for="password" > Repeter le mot de passe</label>
        <input class="rounded  w-full border-[1px] border-gray-400  px-3" type="password" name='password2'>
    </div>
