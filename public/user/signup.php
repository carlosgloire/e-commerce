...
<section>
    ...
    {
    ?>
    <div id='flash-message' class='pl-4 text-center justify-center mx-auto max-w-lg shadow-lg leading-5 rounded bg-white text-red-500 text-[16px] transition-opacity duration-500 ease-in'><?php echo $_SESSION['flash_message']?></div><?php
    }
    ?> 
    <div class='max-w-lg mx-auto py-4 pl-24 pr-24 mt-6 items-center justify-center text-lg rounded-lg  shadow-sm bg-white' style="box-shadow: 0px 0px 10px 0px rgb(240 240 240); border: none;">
