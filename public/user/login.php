    ...
    <div class='max-w-lg mx-auto py-4 pl-24 pr-24  mt-[10%] text-lg rounded-lg  shadow-sm bg-gray-100'>
      ...
      <form action="" method='post' class='mb-2'>
        <div class='grid'>
            ...
            <input class="rounded mb-4 w-full outline-none border-[1px] border-gray-400 px-3" type="text" name='username'  value="<?php echo $username; ?>" >
        </div>
        <div class='grid'> 
            <label for="password" method='password'>Mot de passe</label>
            <input class="rounded mb-6 w-full border-[1px] border-gray-400 px-3 " type="password" name='password'>
        </div>
